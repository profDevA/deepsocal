...
export const products: Product[] = [
  {
    ...
    tagline: "",
    description:
      "This notebook is what we use to write down all of our big ideas. Whether you're thoughtfully",
    longDescription: "",
    price: 70,
    currency: "usd",
    shipping: "+ Shipping",
    images: ["/images/shop/the-t-shirt.png"],
    details: [],
    stripePriceId: "",
  ...
  },
  {
    ...
    currency: "usd",
    shipping: "+ Shipping",
    images: ["/images/shop/the-hoodie.png"],
    details: [],
    stripePriceId: "",
  ...
  },
  {
    ...
    currency: "usd",
    shipping: "+ Shipping",
    images: ["/images/shop/the-bottle.png"],
    details: [],
    stripePriceId: "",
