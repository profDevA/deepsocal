      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:0;">
        ...
        <tr>
          <td style="padding:40px;">
            <p style="margin:0 0 8px;font-size:12px;color:#888;text-transform:uppercase;letter-spacing:1px;">New Contact Submission</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
              ...
              <tr>
                <td style="padding:16px 0;border-bottom:1px solid #e8e8e8;">
                  <span style="font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#888;">Message</span><br>
                  <span style="font-size:16px;color:#000;line-height:1.6;margin-top:4px;display:inline-block;">${message || "(no message)"}</span>
                </td>
              </tr>
              <tr>
