...
export default function SideModal({ open, onClose, children }: SideModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-999999 bg-black/50 flex items-center justify-center">
      ...
      <div className="fixed top-0 right-0 m-0 h-full w-[453px] max-w-full p-0 bg-brand overflow-y-auto shadow-[0px_5px_15px_rgba(0,0,0,0.25)] animate-slide-in max-[1025px]:max-w-[90%] flex flex-col">
