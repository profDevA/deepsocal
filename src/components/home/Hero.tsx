...
export default function Hero() {
  ...
  return (
    <section
      ref={root}
      id="hero"
      className="bg-white w-full min-h-svh flex flex-col items-center px-[16px] sm:px-[24px] md:px-[32px] pt-[80px] sm:pt-[100px] md:pt-[125px] pb-[60px] sm:pb-[70px] md:pb-[80px]"
    >
      {/* Content group grows to fill the viewport and centers vertically, so
          when the hero is pinned the heading/video sit balanced rather than
          crammed at the top with a large empty band below. */}
      <div className="flex-1 w-full flex flex-col items-center justify-center gap-[64px] md:gap-[88px]">
      ...
      <a
        ...
        className="hero-arrow inline-flex items-center justify-center mt-[32px] sm:mt-[40px] w-[20px] sm:w-[24px] md:w-[32px] h-auto text-dark animate-bounce hover:opacity-70 transition-opacity"
